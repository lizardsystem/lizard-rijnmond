...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RiverlineResultData.location'
        db.add_column('lizard_rijnmond_riverlineresultdata', 'location', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RiverlineResultData.location'
        db.delete_column('lizard_rijnmond_riverlineresultdata', 'location')
