...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RiverlineResultData.riverline'
        db.add_column('lizard_rijnmond_riverlineresultdata', 'riverline', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_rijnmond.Riverline'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RiverlineResultData.riverline'
        db.delete_column('lizard_rijnmond_riverlineresultdata', 'riverline_id')
