...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RiverlineResultData.relative_level'
        db.add_column('lizard_rijnmond_riverlineresultdata', 'relative_level', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RiverlineResultData.relative_level'
        db.delete_column('lizard_rijnmond_riverlineresultdata', 'relative_level')
    ...
    models = {
        ...
        'lizard_rijnmond.riverlineresultdata': {
            ...
            'relative_level': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
