...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RiverlineResult'
        db.create_table('lizard_rijnmond_riverlineresult', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('strategy', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_rijnmond.Strategy'], null=True, blank=True)),
            ('scenario', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_rijnmond.Scenario'], null=True, blank=True)),
            ('year', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_rijnmond.Year'], null=True, blank=True)),
        ))
        db.send_create_signal('lizard_rijnmond', ['RiverlineResult'])

        # Adding model 'RiverlineResultData'
        db.create_table('lizard_rijnmond_riverlineresultdata', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('riverline_result', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_rijnmond.RiverlineResult'], null=True, blank=True)),
            ('level', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
        ))
        db.send_create_signal('lizard_rijnmond', ['RiverlineResultData'])


    def backwards(self, orm):
        
        # Deleting model 'RiverlineResult'
        db.delete_table('lizard_rijnmond_riverlineresult')

        # Deleting model 'RiverlineResultData'
        db.delete_table('lizard_rijnmond_riverlineresultdata')
